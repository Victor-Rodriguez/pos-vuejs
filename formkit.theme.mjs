 ...
 *
 * @checksum - bafdd128fc652decaa7a1e1c2f7c0f345f3e1b5a1a8e570d50345dcb058473f1
 * @variables - radius=rounded-lg,accentColor=lime,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-lime-500": true,
    "peer-checked:border-lime-600": true,
    relative: true,
    block: true,
    "text-lg": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-lime-50": true,
    "peer-checked:text-lime-600": true,
    ...
    "dark:ring-offset-lime-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-lime-900": true,
    "dark:peer-checked:text-lime-400": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-green-400": true,
    "focus-within:!border-green-400": true,
  ...
  "family:dropdown__inner": {
    ...
    "focus-within:ring-1": true,
    "focus-within:!ring-lime-500": true,
    "focus-within:!border-lime-500": true,
    "group-data-[invalid]:border-red-500": true,
    "group-data-[invalid]:ring-1": true,
    "group-data-[invalid]:ring-red-500": true,
    "group-data-[disabled]:bg-neutral-100": true,
  ...
  "family:dropdown__listitem": {
    ...
    "text-neutral-700": true,
    "text-base": true,
    "data-[is-active]:bg-lime-100": true,
    ...
    "data-[is-active]:before:ring-lime-500": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-lime-100": true,
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-lime-500": true,
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-lime-400": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-lime-600": true,
  },
  button__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  date__input: {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-lime-100": true,
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-lime-100": true,
  },
  file__fileList: {
    "group/list": true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-lime-600": true,
  ...
  form__messageLink: {
    ...
    "group-[]/summary:ring-lime-600": true,
  },
  month__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-lime-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-lime-500": true,
    ...
    "[&::-moz-range-thumb]:bg-lime-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-lime-500": true,
  ...
  select__option: {
    ...
    "group-data-[multiple]:checked:bg-lime-100": true,
    "group-data-[multiple]:focus:bg-lime-100": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:group-data-[multiple]:focus:bg-lime-800": true,
    "dark:group-data-[multiple]:checked:bg-lime-800": true,
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  week__input: {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-lime-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-lime-100": true,
  },
  ...
  colorpicker__control: {
    ...
    "focus-visible:ring-lime-500": true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input]:selection:bg-lime-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-lime-600": true,
    "[&>input:focus]:border-lime-600": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-lime-500": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:aria-selected:bg-lime-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-lime-600": true,
  ...
  datepicker__timeInput: {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-lime-600": true,
    "dark:text-neutral-300": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-600": true,
  },
  ...
  datepicker__dayButton: {
    ...
    "dark:text-neutral-300": true,
    "dark:border-neutral-600": true,
    "dark:hover:border-lime-500": true,
  },
  ...
  datepicker__calendarIcon: {
    "text-neutral-600": true,
    "focus-visible:text-lime-600": true,
    flex: true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  rating__ratingItem: {
    ...
    "focus-within:outline-lime-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true,
  },
  ...
  toggle__track: {
    ...
    "shadow-sm": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-lime-500": true,
  ...
  togglebuttons__input: {
    ...
    "dark:disabled:text-lime-500": true,
    "dark:text-lime-500": true,
    "aria-[pressed=true]:bg-lime-600": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-lime-600": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-lime-500": true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-lime-600": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-lime-600": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-lime-600": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-lime-600": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-lime-600": true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-lime-500": true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-lime-600": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-lime-600": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-lime-600": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-lime-600": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-lime-600": true,
  },
  transferlist__outer: {
    group: true,
    "min-w-0": true,
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-lime-600": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-lime-500": true,
    "dark:border-neutral-600": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "aria-selected:bg-lime-100": true,
    "data-[is-active=true]:bg-lime-100": true,
    "data-[is-active=true]:ring-lime-200": true,
    "aria-selected:ring-lime-200": true,
    relative: true,
    flex: true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-lime-900": true,
    "dark:aria-selected:bg-lime-900": true,
    "dark:ring-neutral-700": true,
    "dark:data-[is-active=true]:ring-lime-600": true,
    "dark:aria-selected:ring-lime-600": true,
    "[&.formkit-dropZone]:bg-lime-100": true,
    "[&.formkit-selectionDropZone]:bg-lime-100": true,
    "[&.formkit-touchDropZone]:bg-lime-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-lime-100": true,
    "[&.formkit-longTouch]:bg-lime-100": true,
    "dark:[&.formkit-dropZone]:bg-lime-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-lime-900": true,
    "dark:[&.formkit-touchDropZone]:bg-lime-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-lime-900": true,
    "dark:[&.formkit-longTouch]:bg-lime-900": true,
  },
  ...
  transferlist__transferlistSearch: {
    ...
    "dark:border-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:selection:bg-lime-100": true,
    "dark:selection:text-neutral-700": true,
    "dark:bg-neutral-800": true,
  },
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-lime-600": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-lime-600": true,
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-lime-600": true,
